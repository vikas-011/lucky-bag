...
! function(a, b, c, d) {
    ...
    function e(b, c, d) {
        this.element = a(b), this._defaults = g, this._name = f, c = c.replace(/\.\w*$/, ""), this.settings = a.extend({}, g, d), this.path = c, this.init()
    }
    var f = "vide",
        g = {
            volume: 1,
    ...
    e.prototype.init = function() {
        ...
        }), l(this.path, function(a) {
            b.wrapper.css("background-image", "url(" + a + ")")
        }), "static" === this.element.css("position") && this.element.css("position", "relative"), this.element.prepend(this.wrapper), h || i || (this.video = a("<video><source src='" + this.path + ".mp4' type='video/mp4'><source src='" + this.path + ".webm' type='video/webm'><source src='" + this.path + ".ogv' type='video/ogg'></video>"), this.video.css("visibility", "hidden"), this.video.prop({
        ...
        this.element.unbind(f), this.video && this.video.unbind(f), delete a[f].lookup[this.index], this.element.removeData(f), this.wrapper.remove()
    }, a.fn[f] = function(b, c) {
        var d;
